...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ngsdbview_chromosome', 'genome_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='ES022', to=orm['ngsdbview.Organism'], to_field='organismcode'),
                      keep_default=False)

        # Adding field 'Chromosome.genome_version'
        db.add_column(u'ngsdbview_chromosome', 'genome_version',
                      self.gf('django.db.models.fields.CharField')(default='0.1', max_length=10),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'ngsdbview_chromosome', 'organism',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ngsdbview.Organism']),
                      keep_default=False)
    ...
    models = {
        ...
        u'ngsdbview.chromosome': {
            ...
            'genome_version': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
