...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Statistics_CV.cvgroup_id'
        db.delete_column(u'ngsdbview_statistics_cv', 'cvgroup_id')

        # Adding unique constraint on 'Statistics_cv', fields ['cvterm']
        db.create_unique(u'ngsdbview_statistics_cv', ['cvterm'])

        # Deleting field 'Statistics.stats_cvterm_id'
        db.delete_column(u'ngsdbview_statistics', 'stats_cvterm_id_id')

        # Adding field 'Statistics.stats_cvterm'
        db.add_column(u'ngsdbview_statistics', 'stats_cvterm',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ngsdbview.Statistics_cv'], to_field='cvterm'),
                      keep_default=False)


        # Changing field 'Statistics.cv_value'
        db.alter_column(u'ngsdbview_statistics', 'cv_value', self.gf('django.db.models.fields.IntegerField')())
        # Deleting field 'Chromosome.organism'
        db.delete_column(u'ngsdbview_chromosome', 'organism_id')

        # Adding field 'Chromosome.genome_name'
        db.add_column(u'ngsdbview_chromosome', 'genome_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ngsdbview.Organism'], to_field='organismcode'),
                      keep_default=False)

        # Adding field 'Chromosome.genome_version'
        db.add_column(u'ngsdbview_chromosome', 'genome_version',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)

        # Adding field 'SNP_Summary.value_type'
        db.add_column(u'ngsdbview_snp_summary', 'value_type',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Statistics_cv', fields ['cvterm']
        db.delete_unique(u'ngsdbview_statistics_cv', ['cvterm'])

        # Adding field 'Statistics_CV.cvgroup_id'
        db.add_column(u'ngsdbview_statistics_cv', 'cvgroup_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Statistics.stats_cvterm_id'
        db.add_column(u'ngsdbview_statistics', 'stats_cvterm_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='AC', to=orm['ngsdbview.Statistics_CV']),
                      keep_default=False)

        # Deleting field 'Statistics.stats_cvterm'
        db.delete_column(u'ngsdbview_statistics', 'stats_cvterm_id')


        # Changing field 'Statistics.cv_value'
        db.alter_column(u'ngsdbview_statistics', 'cv_value', self.gf('django.db.models.fields.TextField')())
        # Adding field 'Chromosome.organism'
        db.add_column(u'ngsdbview_chromosome', 'organism',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['ngsdbview.Organism']),
                      keep_default=False)

        # Deleting field 'Chromosome.genome_name'
        db.delete_column(u'ngsdbview_chromosome', 'genome_name_id')

        # Deleting field 'Chromosome.genome_version'
        db.delete_column(u'ngsdbview_chromosome', 'genome_version')

        # Deleting field 'SNP_Summary.value_type'
        db.delete_column(u'ngsdbview_snp_summary', 'value_type')
    ...
    models = {
        ...
        u'ngsdbview.statistics': {
            ...
            'cv_value': ('django.db.models.fields.IntegerField', [], {}),
            'snp': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ngsdbview.SNP']"}),
            'stats_cvterm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ngsdbview.Statistics_cv']", 'to_field': "'cvterm'"}),
        ...
        u'ngsdbview.statistics_cv': {
            ...
            'cvterm': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
            'cvterm_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
