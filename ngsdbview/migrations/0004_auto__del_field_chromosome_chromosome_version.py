...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Chromosome.chromosome_version'
        db.delete_column(u'ngsdbview_chromosome', 'chromosome_version')


    def backwards(self, orm):
        # Adding field 'Chromosome.chromosome_version'
        db.add_column(u'ngsdbview_chromosome', 'chromosome_version',
