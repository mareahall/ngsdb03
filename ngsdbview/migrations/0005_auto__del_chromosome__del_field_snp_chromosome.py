...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SNP.chromosome'
        db.delete_column(u'ngsdbview_snp', 'chromosome_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SNP.chromosome'
        db.add_column(u'ngsdbview_snp', 'chromosome',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ngsdbview.Chromosome']),
                      keep_default=False)
