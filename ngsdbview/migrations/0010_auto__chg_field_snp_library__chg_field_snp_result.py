...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SNP.library'
        db.alter_column(u'ngsdbview_snp', 'library_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ngsdbview.Library']))

        # Changing field 'SNP.result'
        db.alter_column(u'ngsdbview_snp', 'result_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ngsdbview.Result']))

    def backwards(self, orm):

        # Changing field 'SNP.library'
        db.alter_column(u'ngsdbview_snp', 'library_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ngsdbview.Library'], null=True))

        # Changing field 'SNP.result'
        db.alter_column(u'ngsdbview_snp', 'result_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ngsdbview.Result'], null=True))
