...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SNP.referenceBase'
        db.alter_column(u'ngsdbview_snp', 'referenceBase', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'SNP.alternateBase'
        db.alter_column(u'ngsdbview_snp', 'alternateBase', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'SNP.referenceBase'
        db.alter_column(u'ngsdbview_snp', 'referenceBase', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'SNP.alternateBase'
        db.alter_column(u'ngsdbview_snp', 'alternateBase', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        u'ngsdbview.snp': {
            ...
            'alternateBase': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            ...
            'referenceBase': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'result': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ngsdbview.Result']"}),
