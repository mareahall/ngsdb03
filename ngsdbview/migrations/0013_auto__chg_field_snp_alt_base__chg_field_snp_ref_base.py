...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SNP.alt_base'
        db.alter_column(u'ngsdbview_snp', 'alt_base', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'SNP.ref_base'
        db.alter_column(u'ngsdbview_snp', 'ref_base', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'SNP.alt_base'
        db.alter_column(u'ngsdbview_snp', 'alt_base', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'SNP.ref_base'
        db.alter_column(u'ngsdbview_snp', 'ref_base', self.gf('django.db.models.fields.CharField')(max_length=10))
