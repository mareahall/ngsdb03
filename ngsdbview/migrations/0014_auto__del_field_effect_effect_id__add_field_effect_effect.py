...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Effect.effect_id'
        db.delete_column(u'ngsdbview_effect', 'effect_id_id')

        # Adding field 'Effect.effect'
        db.add_column(u'ngsdbview_effect', 'effect',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ngsdbview.Effect_CV']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Effect.effect_id'
        db.add_column(u'ngsdbview_effect', 'effect_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ngsdbview.Effect_CV']),
                      keep_default=False)

        # Deleting field 'Effect.effect'
        db.delete_column(u'ngsdbview_effect', 'effect_id')
