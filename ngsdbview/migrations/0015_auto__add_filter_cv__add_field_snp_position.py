...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ngsdbview_filter_cv', (
            ('filterCV_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filter_type', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'ngsdbview', ['Filter_CV'])

        # Adding field 'SNP.position'
        db.add_column(u'ngsdbview_snp', 'position',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'ngsdbview_filter_cv')

        # Deleting field 'SNP.position'
        db.delete_column(u'ngsdbview_snp', 'position')
    ...
    models = {
        ...
        u'ngsdbview.effect': {
            ...
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ngsdbview.Effect_CV']"}),
        ...
        u'ngsdbview.filter_cv': {
            'Meta': {'object_name': 'Filter_CV'},
            'filterCV_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'ngsdbview.snp': {
            ...
            'alt_base': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            ...
            'ref_base': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'result': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ngsdbview.Result']"}),
